        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="page-header-actions">
                    ...
                    <a class="btn btn-sm btn-default btn-outline btn-round {{ Route::is('sub-category-list') ? 'active' : '' }}" href="{{  route('sub-category-list') }}">
                        <i class="icon wb-list-bulleted" aria-hidden="true"></i>
                        <span class="hidden-sm-down"> Sub Category</span>
                    </a>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="example-wrap mb-0">
                            <h4 class="example-title">Add Sub Category</h4>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="example-wrap mb-35">
                    ...
                    <div class="form-group row">
                        <label for="category_name" class="col-md-4"><span class="text-danger">*</span>Category Name:</label>
                        <div class="col-md-8">
                            <select id="child_category_name" name="child_category_name"class="form-control" >
                                <option selected disabled>Please Select Child Category</option>
                            </select>
                    ...
                    <div class="form-group row">
                        <label for="category_name" class="col-md-4"><span class="text-danger">*</span>Sub Category Name:</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" placeholder="Sub Category Name" id="category_name" name="category_name" value="{{ isset($category->category_name) ? $category->category_name : old('category_name')}}">
                            <span class="help-block text-help text-danger" id="category_name-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="position" class="col-md-4"><span class="text-danger">*</span>Category Position:</label>
                        <div class="col-md-8">
                            <input type="number" class="form-control" placeholder="Category position" id="position" name="position" min="1" value="{{ isset($category->position) ? $category->position : old('position')}}">
