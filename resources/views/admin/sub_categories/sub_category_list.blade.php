...
<div class="page-header pb-0">
    <div class="panel">
        <div class="panel-body">
            <h1 class="page-title">List of Sub Category</h1>
            <ol class="breadcrumb">
            ...
            <div class="page-header-actions">
                <a class="btn btn-sm btn-default btn-outline btn-round {{ Route::is('add-sub-category') ? 'active' : '' }}" href="{{ route('add-sub-category') }}">
                    <i class="icon wb-plus" aria-hidden="true"></i>
                    <span class="hidden-sm-down">Add Sub Category</span>
                </a>
            </div>
        </div>
    </div>
